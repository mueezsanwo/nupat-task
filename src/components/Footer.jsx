  ...
  return (
    <div>
        <div>
            ...
            <div className=' bg-[#091242] w-full h-[562px] '>
                <nav className=' flex justify-center items-center gap-32 bg-white bg-opacity-25 h-[78px] '>
                   <div className=' bg-[#091242] -ml-[500px] h-[78px] flex items-center justify-center '>
                    ...
                    <ul className=' flex justify-between -ml-[0px] text-white'>
                    <li className=' ml-8 w-[74px] h-[30px] font-medium text-2xl'>Pages</li>
                    <li className=' ml-8 w-[74px] h-[30px] font-medium text-2xl'>Utility</li>
                    <li className=' ml-8 w-[74px] h-[30px] font-medium text-2xl'>Subscribe</li>
                    </ul>
                </nav>
                <div className=' flex ml-10 mt-5'>
                    <div>
                    <p className=' text-[#E8E8E8] text-base font-medium w-[319px] h-[92px] text-left align-top mt-5 leading-6 ml-[100px]'>Leverage agile frameworks to provide a robust synopsis for strategy  collaborative thinking to further the overall value proposition. </p>
                    <div className=' flex font-medium text-xs text-white mt-[22px] ml-[100px]'>
         ...
         <div className=' ml-[100px] flex font-medium text-white text-xs mt-[22px]'>
         ...
         <p className=' h-[40px] w-[107px] py-[13.5px]  ml-2'>Call Us <br /> (00) 112 365 489</p>
                    ...
                    <div className=' text-white ml-0 mt-5 '>
                    <ul className='  gap-14 w- my-[] h-[22px]  '>
            <li>About Us</li>
            <li>Our Team</li>
            <li>Our Project</li>
            <li>Pricing</li>
            <li>Contact</li>
                ...
                <div className=' float-right -mt-[260px] mr-[350px]'>
                <input type='City' placeholder='  Email here' className=' w-[365px] h-[60px] border border-[#4E5683] bg-transparent' />
                <div>
            ...
            <li><img src={Facebook} alt='/' className=' w-[20px] h-[20px]'  /></li>
                ...
                <div className=' flex justify-center bg-[#091242] gap-4 h-[40px] border-t-[1px] border-[#8388A7] '>
                    <h1 className=' text-white mt-2'>Copyright © TransitFlow | Designed by VictorFlow - Powered by Webflow.</h1>
                    <ul className=' flex gap-4 text-[#8388A7] mt-2 '>
                        <li>StyleGuide</li>
                        <li>License</li>
                        <li>Changelog</li>
                        <li>Password</li>
